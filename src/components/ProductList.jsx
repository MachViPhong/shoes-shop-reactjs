...
export default class ProductList extends Component {
    ...
    renderProduct = () =>{
      const {addToCart, viewDetail} = this.props;
        return dataProducts.map((prod, index) =>{
            return <div className='col-12 col-sm-6 col-md-4 col-lg-4' keu={index}>
                <ProductItem prod={prod} addToCart={addToCart} viewDetail={viewDetail}/>
            </div>
        })
    }
  render() {
